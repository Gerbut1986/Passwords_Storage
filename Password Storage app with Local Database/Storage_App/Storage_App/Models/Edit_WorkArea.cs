namespace Storage_App.Models
{
    ...
    class Edit_WorkArea
    {
        public string Update(Work_Area e, int table_number)
        {
            string MSG = string.Empty;

            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["Storage_App.Properties.Settings.Storage_DBConnectionString"].ConnectionString);
            conn.Open();
            SqlCommand cmd = new SqlCommand($"UPDATE Work_Area_{table_number} SET Site_Name=@Site_Name, " +
