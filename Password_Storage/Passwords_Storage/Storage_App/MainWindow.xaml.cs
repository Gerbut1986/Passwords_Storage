    ...
    public partial class MainWindow : Window
    {
        ...
        private void okBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (loginTxt.Text == "" && passTxt.Password == "")
                MessageBox.Show("All fields is Empty.. Try fill it, and once again!", "All fields was Empty", MessageBoxButton.OK, MessageBoxImage.Warning);
            else if (loginTxt.Text == "" || passTxt.Password == "")
                MessageBox.Show("Some of field is Empty.. Try fill it, and once again!", "Some of the field was Empty", MessageBoxButton.OK, MessageBoxImage.Warning);
            else
            {
